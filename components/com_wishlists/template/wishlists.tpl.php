...
$user =& JFactory::getUser();
	if ($user->guest) { ?>
<a class="add_wishlist hasTooltip <?php if (in_array($product->virtuemart_product_id, $_SESSION['id'])) { echo 'go_to_whishlist active'; }?>"  title="<?php echo JText::_('ADD_TO_WHISHLIST');?>"  onclick="addToWishlists('<?php echo $product->virtuemart_product_id; ?>');"><i class="fa fa-heart-o"></i><span><?php echo JText::_("ADD_TO_WHISHLIST"); ?></span></a>
<?php }else {
