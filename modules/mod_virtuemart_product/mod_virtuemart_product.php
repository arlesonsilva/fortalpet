...
$display_izotop = 	(bool)$params->get( 'display_izotop', 0 ); // Display Style
$products_per_row = $params->get( 'products_per_row', 4 ); // Display X products per Row
$show_img = 		(bool)$params->get( 'show_img', 1 ); // Display the Images?
$show_category = 		(bool)$params->get( 'show_category', 1 ); // Display the Product Category?
$show_ratings = 		(bool)$params->get( 'show_ratings', 1 );
$show_title = 		(bool)$params->get( 'show_title', 1 ); // Display the Product Title?
$show_desc = 		(bool)$params->get( 'show_desc', 1 ); // Display the Product Desc?
$row = $params->get    ('row_desc', 40);
$show_det = 		(bool)$params->get( 'show_det', 1 ); // Display the Product Details?
...
$show_tolltips = 		(bool)$params->get( 'enable_tolltips', 0 ); // Display the Product Price?
...
if (!($output = $cache->get($key))) {
	...
	/* Load tmpl default */
	 if ($display_izotop) { 
		JHTML::script(JURI::base().'modules/mod_virtuemart_product/js/izotop.min.js');
	 }
