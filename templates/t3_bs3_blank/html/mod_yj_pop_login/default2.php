...
<div class="poping_links"> <?php echo $params->get('pretext'); ?>
	...
	<a  href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>"  id="openReg"><?php echo JText::_('REGISTER'); ?></a> 
	<?php endif; ?>
</div>
<!-- login -->
<!-- registration  -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<?php endif; ?>
		 ...
		 <?php $usersConfig = &JComponentHelper::getParams( 'com_users' ); if ($usersConfig->get('allowUserRegistration')) : ?>
                <a class="reg_btn button reset"  href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>"  ><?php echo JText::_('REGISTER'); ?></a> 
         <?php endif; ?>
      	 </div>
