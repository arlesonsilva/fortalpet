...
<?php
	...
	*/
	function getFooter()
	{
		...
		if ($this->getVar('comments-refresh', 1) == 1) {
			$lines[] = '<a class="refresh" href="#" title="'.JText::_('BUTTON_REFRESH').'" onclick="jcomments.showPage('.$object_id.',\''. $object_group . '\',0);return false;"><i class="fa fa-refresh fa-spin"></i>&nbsp;'.JText::_('BUTTON_REFRESH').'</a>';
		}
