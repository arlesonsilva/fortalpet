...
?>
	<span class="marg-bot">
		...
		<input class="inputbox" id="comments-form-name" type="text" name="name" value="" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" />
	</span>
<?php
		}
...
<div id="comments-form-buttons">
	<div  id="comments-form-send"><a class="button" href="#" tabindex="7" onclick="jcomments.saveComment();return false;" title="<?php echo JText::_('FORM_SEND_HINT'); ?>"><?php echo JText::_('FORM_SEND'); ?></a></div>
	<div  id="comments-form-cancel" style="display:none;"><a class="button reset" href="#" tabindex="8" onclick="return false;" title="<?php echo JText::_('FORM_CANCEL'); ?>"><?php echo JText::_('FORM_CANCEL'); ?></a></div>
