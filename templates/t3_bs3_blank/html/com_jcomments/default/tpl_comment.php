...
<?php
					...
					if ($this->getVar('button-quote') == 1) {
?>
<a href="#" onclick="jcomments.quoteComment(<?php echo $comment->id; ?>); return false;"><i class="fa fa-quote-left"></i>&nbsp;
<?php echo JText::_('BUTTON_QUOTE'); ?>&nbsp;<i class="fa fa-quote-right"></i>
</a>
<?php
					}
...
?>
	<a class="toolbar-button-edit" href="#" onclick="jcomments.editComment(<?php echo $comment->id; ?>); return false;" title="<?php echo $text; ?>"><i class="fa fa-pencil-square-o"></i>
</a>
<?php
			}
...
?>
	<a class="toolbar-button-delete" href="#" onclick="if (confirm('<?php echo JText::_('BUTTON_DELETE_CONIRM'); ?>')){jcomments.deleteComment(<?php echo $comment->id; ?>);}return false;" title="<?php echo $text; ?>"><i class="fa fa-times"></i>
...
<?php
			...
			if ($this->getVar('button-publish') == 1) {
				...
				$class2 = $comment->published ? '-bell' : '-bell-o';
?>
	<a class="toolbar-button-<?php echo $class; ?>" href="#" onclick="jcomments.publishComment(<?php echo $comment->id; ?>);return false;" title="<?php echo $text; ?>"><i class="fa fa<?php echo $class2; ?>"></i>
</a>
<?php
			}
...
?>
	<a class="toolbar-button-ip" href="#" onclick="jcomments.go('http://www.ripe.net/perl/whois?searchtext=<?php echo $comment->ip; ?>');return false;" title="<?php echo $text; ?>"><i class="fa fa-users"></i>
</a>
<?php
			}
...
?>
	<a class="toolbar-button-ban" href="#" onclick="jcomments.banIP(<?php echo $comment->id; ?>);return false;" title="<?php echo $text; ?>"><i class="fa fa-ban"></i>
</a>
<?php
			}
?>
...
?>
<a href="#" class="vote-poor" title="<?php echo JText::_('BUTTON_VOTE_BAD'); ?>" onclick="jcomments.voteComment(<?php echo $comment->id;?>, -1);return false;"><i class="fa fa-thumbs-down"></i>
</a>
<a href="#" class="vote-good" title="<?php echo JText::_('BUTTON_VOTE_GOOD'); ?>" onclick="jcomments.voteComment(<?php echo $comment->id;?>, 1);return false;"><i class="fa fa-thumbs-up"></i>
</a>
<?php
		}
