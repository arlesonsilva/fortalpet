...
echo '<span class="continue reset2 button" >' . JText::_('COM_VIRTUEMART_CONTINUE_SHOPPING') . '</span>';
echo '<a class="showcart floatright button" href="' . $this->cart_link . '">' . JText::_('COM_VIRTUEMART_CART_SHOW') . '</a>';
