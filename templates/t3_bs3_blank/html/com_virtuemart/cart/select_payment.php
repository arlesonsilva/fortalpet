...
<?php } else {
	...
	echo "<h".$headerLevel." class='module-title'><span>".JText::_('COM_VIRTUEMART_CART_SELECT_PAYMENT')."</span></h".$headerLevel.">";
?>
...
echo "<div class='login-box-metod'>\n";
		...
		foreach ($this->paymentplugins_payments as $paymentplugin_payments) {?>
		   ...
		   <?php  if (is_array($paymentplugin_payments)) { ?>
           
			<?php
			foreach ($paymentplugin_payments as $paymentplugin_payment) {
			    echo '<div class="wrapper">'.$paymentplugin_payment.'</div>';
			?>
	 ...
	 echo "<p>".$this->payment_not_found_text."</p>";
    }
