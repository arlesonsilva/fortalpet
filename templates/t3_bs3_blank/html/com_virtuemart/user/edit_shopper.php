...
<div class="buttonBar-right user">
	...
	&nbsp;
	<button class="button reset" type="reset" onclick="window.location.href='<?php echo JRoute::_('index.php?option=com_virtuemart&view=user'); ?>'" ><?php echo vmText::_('COM_VIRTUEMART_CANCEL'); ?></button>
<div class="clear"></div>
</div>
<?php } ?>
