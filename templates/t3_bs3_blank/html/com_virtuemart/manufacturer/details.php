...
<div class="manufacturer_details_view">
	<h3 class="module-title"><?php echo $this->manufacturer->mf_name; ?></h3>
...
<?php // Manufacturer Email
	...
	if(!empty($this->manufacturer->virtuemart_manufacturer_id)) { ?>
		<div class="manufacturer-product-link">
			<a class="btn_man" target="_top" href="<?php echo $manufacturerProductsURL; ?>"><?php echo JText::sprintf('COM_VIRTUEMART_PRODUCT_FROM_MF',$this->manufacturer->mf_name); ?></a>
		</div>
	<?php } ?>
</div>
	</div>
