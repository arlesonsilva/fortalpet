...
<h3 class="module-title"><?php echo JText::_('DR_MANUFACTURER'); ?></h3>
<div class="manufacturer-view-default">
	...
	foreach ( $this->manufacturers as $manufacturer ) {
		...
		<div class="manufacturer floatleft<?php echo $manufacturerCellWidth . $showVerticalSeparator ?>">
			<div class="spacer">
            <a class="box-indent" title="<?php echo $manufacturer->mf_name; ?>" href="<?php echo $manufacturerURL; ?>"><?php echo $manufacturerImage;?></a>
				<h2>
