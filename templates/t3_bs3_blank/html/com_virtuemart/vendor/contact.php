...
<div class="vendor-details-view">
	<h3 class="module-title"><?php echo $this->vendor->vendor_store_name; ?>
		</h3>
...
?>
		...
		<h3 class="module-title"><?php echo vmText::_('COM_VIRTUEMART_VENDOR_ASK_QUESTION')  ?></h3>

		<div class="clear"></div>

		<div class="form-field boxIndent">

			<form method="post" class="form-validate" action="<?php echo JRoute::_('index.php') ; ?>" name="askform" id="askform">

				<label><?php echo vmText::_('COM_VIRTUEMART_USER_FORM_NAME')  ?> : <br /><input type="text" class="validate[required,minSize[4],maxSize[64]] inputbox" value="<?php echo $this->user->name ?>" name="name" id="name" size="30"  validation="required name"/></label>
				<label><?php echo vmText::_('COM_VIRTUEMART_USER_FORM_EMAIL')  ?> :<br /> <input type="text" class="validate[required,custom[email]] inputbox" value="<?php echo $this->user->email ?>" name="email" id="email" size="30"  validation="required email"/></label>
				<label>
					<?php
				...
				<div class="submit">
					<button class="ven_button button" type="submit" value="<?php echo vmText::_('COM_VIRTUEMART_ASK_SUBMIT')  ?>"><?php echo vmText::_('COM_VIRTUEMART_ASK_SUBMIT')  ?></button>
				</div>
