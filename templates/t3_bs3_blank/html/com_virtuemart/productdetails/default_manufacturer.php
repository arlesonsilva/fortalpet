...
<div class="manufacturer">
	...
	?>
        <span class="bold"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_DETAILS_MANUFACTURER_LBL') ?></span><a class="modal vm2" rel="{handler: 'iframe', size: {x: 260, y: 260}}" href="<?php echo $link ?>"><?php echo $text ?></a>
    <?PHP } ?>
</div>