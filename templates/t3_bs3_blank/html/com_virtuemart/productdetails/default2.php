...
<div class="wrapper2">
    ...
    <div class="fright">
		...
		<div class="rating">
			...
			$ratingModel = VmModel::getModel('ratings');
			 ...
			 $showRating = $ratingModel->showRating($this->productproduct->virtuemart_product_id);
			 if ($showRating=='true'){
 ...
 if ($this->product->customfieldsSorted['related_products']) {
	echo $this->loadTemplate('relatedproducts2');
 }
...
<script type="text/javascript">
			jQuery(document).ready(function()
			{
				...
				jQuery('.productdetails-view.layout2 .product-box2 .hasTooltip').tooltip();
			});
			jQuery(function(){
