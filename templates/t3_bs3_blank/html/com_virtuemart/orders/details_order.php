...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
	...
	<td class="orders-key price" align="left"><?php echo $this->currency->priceDisplay($this->orderdetails['details']['BT']->order_total, $this->currency); ?></td>
    </tr>
...
<div class="order-box2">
   ...
   <table width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr>
	<td class="first" valign="top"><h3 class="module-title">
	    <?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_BILL_TO_LBL') ?></h3>
	    <div class="order-box"><table width="100%"><?php
    ...
    <td class="first" width="4%"></td>
	<td class="first" valign="top" ><h3 class="module-title">
	    <?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_SHIP_TO_LBL') ?></h3>
	    <div class="order-box"><table width="100%"><?php
