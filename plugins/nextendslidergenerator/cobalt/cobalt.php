        ...
        if($showall || smartsliderIsFull()){
            $installed = NextendFilesystem::existsFolder(JPATH_ADMINISTRATOR.DIRECTORY_SEPARATOR.'components'.DIRECTORY_SEPARATOR.'com_cobalt');
    	      if ($showall || $installed) {
                ...
                $list[$this->_group][$this->_group . '_records'] = array(NextendText::_('Records'), $this->getPath() . 'records' . DIRECTORY_SEPARATOR, true, true, $installed ? true : 'http://extensions.joomla.org/extensions/authoring-a-content/content-construction/21340');
            }
        }
    }
