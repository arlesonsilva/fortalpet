    ...
    function onNextendSliderGeneratorList(&$group, &$list, $showall = false) {
        ...
        if ($showall || smartsliderIsFull()) {
            ...
            if ($showall || $installed) {
                ...
                $list[$this->_group][$this->_group . '_items'] = array(NextendText::_('Items'), $this->getPath() . 'items' . DIRECTORY_SEPARATOR, true, true, $installed ? true : 'http://extensions.joomla.org/extensions/authoring-a-content/content-construction/10667', 'article');
            }
        }
    }
