...
class plgSystemYtshortcodes extends JPlugin{
	...
	public function onBeforeRender()
	{
		...
		$opt_content2 = $app->input->getCmd('view', '');
		$user = JFactory::getUser();
		if($this->params->get('show_sjjquery', 0)==1 && $version->RELEASE=='2.5' ){
			if(!$app->isSite()){
				if($opt_content2=='com_modules' || $opt_content2=='com_content' ){
	...
	public function listShortCodes()
	{
		...
		'gallery' => array(
			'name'		=> "Gallery",
			'desc'		=> "Gallery",
			'syntax'	=> "[gallery title=\'GALLERY_TITLE\' width=\'IMAGE_THUMB_WIDTH\' height=\'IMAGE_THUMB_HEIGHT\' columns=\'3\']<br/>[gallery_item title=\'IMAGE_TITLE\' txt=\'TEXT\' desc=\'DESC\' src=\'IMAGE_SRC\' video_addr=\'VIDEO_ADDRESS\']IMAGE_DESCRIPTION[/gallery_item]<br/>[gallery_item title=\'IMAGE_TITLE\' txt=\'TEXT\' desc=\'DESC\' src=\'IMAGE_SRC\' video_addr=\'VIDEO_ADDRESS\']IMAGE_DESCRIPTION[/gallery_item]<br/>[gallery_item title=\'IMAGE_TITLE\' txt=\'TEXT\' desc=\'DESC\' src=\'IMAGE_SRC\' video_addr=\'VIDEO_ADDRESS\']IMAGE_DESCRIPTION[/gallery_item]<br/>[/gallery]",
			'image'		=> "gallery.png"
		),
		'icon' => array(
			'name'		=> "Retina Icons",
